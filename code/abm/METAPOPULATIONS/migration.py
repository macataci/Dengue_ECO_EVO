...
data = model.saveToDataFrame('../../../output/METAPOPULATIONS/metapopulations_migration_example.csv')
graph = model.populationsPlot( # Plot infected hosts per population over time.
    '../../../figs/METAPOPULATIONS/metapopulations_migration_example.png', data,
