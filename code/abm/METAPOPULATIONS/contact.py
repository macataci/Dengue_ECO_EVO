...
data = model.saveToDataFrame('../../../output/METAPOPULATIONS/metapopulations_population_contact_example.csv')
graph = model.populationsPlot( # Plot infected hosts per population over time.
    '../../../figs/METAPOPULATIONS/metapopulations_population_contact_example.png', data,
