...
my_model.addPathogensToHosts( 'my_population',{'AAAAAAAAAA':30} )
my_model.run(0,100)
...
# fitness value.
#
# TODO positive number till infinite?
#
# Here, we take advantage of one of the preset functions, but you
...
graph_compartments = model.compartmentPlot(
    ...
    # multiple genotypes is counted twice
    # TODO por qué twice? no depende del número de genotypes?
